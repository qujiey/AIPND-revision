...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        #print("key: {} index0: {} index1: {} index2: {} index3: {} index4: {}".format(key, results_dic[key][0], results_dic[key][1], results_dic[key][2], results_dic[key][3], results_dic[key][4])) 
    ...
    if results_stats_dic['n_notdogs_img'] > 0:
        ...
        #print("################# n_correct_notdogs: {} n_notdogs_img: {}".format(results_stats_dic['n_correct_notdogs'], results_stats_dic['n_notdogs_img']))
    else:
